...
import com.training.project.ui.opengl2.utils.ProjectionMatrixHelper
 ...
 * @FileName:        ColorfulRenderer
 * @Description:     渐变色
 */
class ColorfulRenderer(context: Context) : BaseRenderer(context) {
    ...
    private val mVertexData: FloatBuffer = BufferUtil.createFloatBuffer(POINT_DATA)
    private val mColorData: FloatBuffer = BufferUtil.createFloatBuffer(COLOR_DATA)
    ...
    override fun onSurfaceCreated(gl: GL10?, config: EGLConfig?) {
        ...
        GLES20.glVertexAttribPointer(aColorLocation, COLOR_COMPONENT_COUNT, GLES20.GL_FLOAT, false, 0, mColorData)
